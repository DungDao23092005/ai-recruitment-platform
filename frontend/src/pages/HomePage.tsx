...
import { Hero3DMatchPreview } from '@/components/home/Hero3DMatchPreview'
  ...
  return (
    <div className="relative">
      ...
      <section className="container py-16 sm:py-20">
        ...
        <AnimatedSection delay={100} rootMargin="0px 0px -50px">
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {AI_FEATURES.map((feature, featureIndex) => (
              <AnimatedSection
                ...
                rootMargin="0px 0px -50px"
              >
                <Card className="card-hover border-border/70 hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-soft">
                  <CardHeader>
      ...
      <section className="container pb-16 sm:pb-20">
        <AnimatedSection delay={0} rootMargin="0px 0px -50px">
